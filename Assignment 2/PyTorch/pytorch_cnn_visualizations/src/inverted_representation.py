...
from pytorch_cnn_visualizations.src.misc_functions import get_params, \
    recreate_image
...
class InvertedRepresentation():
    ...
    def generate_inverted_image_specific_layer(self, input_image, img_size,
                                               filename, target_layer=3):
        ...
        for i in range(201):
            ...
            reg_alpha = alpha_reg_lambda * self.alpha_norm(opt_img,
                                                           alpha_reg_alpha)
